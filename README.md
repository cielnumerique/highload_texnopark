...
|---|---|---|---|
| Видео - раздача | ≈ 142 000 видеоединиц | ≈ 2 220 ТБ (≈2,2 ПБ) | ≈18,8 ГБ/час контента по всей лестнице качеств, на основе битрейтов по уровням [8] |
...
| Пользовательские данные (профиль, история, список, оценки) | ≈ 315 млн профилей | ≈ 36,5 ТБ | 386 записей × ~300 байт на пользователя |
